...
class SnackBar{
  make(type, snack_array, time){
     ...
     if(snack_array[4] == "text-success"){
        var icon = "<i class='fa fa-check "+snack_array[4]+"' style='font-size: 17px;'></i> ";
     }else{
        var icon = "<i class='fa fa-times "+snack_array[4]+"' style='font-size: 17px;'></i> ";
     }
    ...
    var snack_html = 
       ...
       ' <div class="wrap">'+
          '<div class="text">'+icon+' '+snack_message+'</div>'+
          '<button><i class="icon-cross2"></i></button>'+
