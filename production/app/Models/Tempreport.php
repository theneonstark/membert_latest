...
{
    protected $fillable = ['number','mobile','provider_id','api_id','amount','bankcharge','charge','profit','gst','tds','apitxnid','txnid','payid','refno','description','remark','option1','option2','option3','option4','option5','option6','option7','option8','status','user_id','credit_by','rtype','via','closing','balance','trans_type','product','create_time', 'transfer_mode','wid', 'wprofit'];
